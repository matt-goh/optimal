    ...
    if (file) {
      ...
      try {
        const { data, error } = await supabase.storage
          .from("resource_images") // Your bucket name
      ...
      // If no file is provided, return null or a default image URL
      return null;
    }
  };
                ...
                <form onSubmit={handleSubmit} className="mt-2 space-y-4">
                  ...
                  <div className="mt-4">
                    ...
                    {imagePreviewUrl ? (
                      ...
                      <div
                        className="mt-2 flex justify-center items-center rounded-md border border-dashed border-gray-900/25 px-6 py-8"
