  ...
  return (
    <html lang="en" className="dark">
      <body className="antialiased dark:text-zinc-200 bg-white dark:bg-zinc-900/95 transition-colors duration-500">
        <UserProvider>
          <div className="z-40 top-0 inset-x-0 flex justify-center overflow-hidden pointer-events-none"></div>
          <div className="sticky top-0 z-50 w-full backdrop-blur flex-none transition-colors duration-500 lg:z-50 lg:border-b lg:border-zinc-900/10 dark:border-zinc-50/[0.06] bg-white supports-backdrop-blur:bg-white/95 dark:bg-zinc-900/75">
                ...
                <div className="fixed z-20 top-[3.8125rem] bottom-0 right-[max(0px,calc(50%-45rem))] w-[19.5rem] py-10 overflow-y-auto hidden xl:block">
                  <div className="px-8">
                    <p className="">
                      ...
                      possimus voluptas. Lorem ipsum dolor sit amet consectetur
                      adipisicing elit. Voluptatibus amet rem commodi est sequi,
                      officiis veniam impedit soluta, ab sed enim, reiciendis
                      voluptatem quo exercitationem. Aspernatur esse laudantium
                      saepe aut. Lorem ipsum dolor, sit amet consectetur
                      adipisicing elit. Excepturi possimus quod neque commodi
                      nobis asperiores ipsum laborum earum perferendis porro id
                      atque aliquid, ex eum? Rem itaque quos nam tempore? Lorem
                      ipsum, dolor sit amet consectetur adipisicing elit.
                      Quisquam vel amet laboriosam molestias suscipit. Suscipit
                      vero explicabo consequuntur doloremque rem id eos,
                      officiis similique architecto, maxime eveniet magnam natus
                      officia.
                    </p>
                  </div>
                </div>
